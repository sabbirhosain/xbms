...
const UpdateAccountModal = () => {
  return (
    <div>
      <div className={`modal fade`} data-bs- id="update_account" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body">
              <h4 className="modal_title">Update Account</h4>
              <form >
                <div className="mb-3">
